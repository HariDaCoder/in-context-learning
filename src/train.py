...
def _sanitize_training_kwargs(args):
    ...
    data_whitelist = {
        ...
        "markov": {"transition_matrix", "A", "A_seq", "noise_std", "initial_std", "bias", "scale", "markov_mode", "markov_scale", "markov_scale_start", "markov_scale_end", "max_seq_length", "seed"},
    ...
    task_whitelist = {
        ...
        "markov_noisy_linear_regression": {"scale", "noise_std", "uniform", "w", "seed"},
