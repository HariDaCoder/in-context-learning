...
def _sanitize_training_kwargs(args):
    ...
    data_whitelist = {
        ...
        "markov": {"transition_matrix", "A", "A_seq", "noise_std", "initial_std", "bias", "scale", "markov_mode", "markov_scale", "markov_scale_start", "markov_scale_end", "max_seq_length", "seed", "normalize_variance"},
    ...
    task_whitelist = {
        ...
        "noisy_context_clean_query": {"scale", "noise_std"},
